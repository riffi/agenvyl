...
const catalog = {
  en: {
    ...
    uninstalling: 'Uninstalling Agenvyl…', uninstalled: 'Agenvyl has been uninstalled.', dataPreserved: 'Your rooms and personal data were preserved.', dataRemoved: 'Application and personal data were removed.', removalScheduled: 'Application files will be removed after this window closes.', closeHint: 'Enter or Q to close',
  ...
  ru: {
    ...
    uninstalling: 'Деинсталляция Agenvyl…', uninstalled: 'Agenvyl деинсталлирован.', dataPreserved: 'Ваши комнаты и личные данные сохранены.', dataRemoved: 'Приложение и личные данные удалены.', removalScheduled: 'Файлы приложения будут удалены после закрытия этого окна.', closeHint: 'Enter или Q — закрыть',
