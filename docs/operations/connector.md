...
AGY publishes assistant text, best-effort tagged reasoning, tool lifecycle,
usage, and its terminal result through the documented `stream-json` print
protocol. It still has no headless approval, clarification, or elicitation round-trip. OpenCode supports
