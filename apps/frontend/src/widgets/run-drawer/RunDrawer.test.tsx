...
const run:Run={id:'run-2',messageId:'message-1',agent:'coder',requestedModel:'provider/model-v1',harnessInstanceId:'local-opencode',harnessType:'opencode',modelId:'provider/model-v1',executionProfile:{workflowMode:'work',requestedReasoningEffort:null,reasoningEffort:null,reasoningEffortFallback:false,reasoningEffortSource:'auto',planEnforcement:null,permissionProfileId:null,agentVariantId:'build'},status:'streaming',connector:{state:'active',checkpointed:true},text:'answer',tools:[],attemptNumber:2};
