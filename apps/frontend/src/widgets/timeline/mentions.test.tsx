...
const personas:Persona[]=[
  {id:'foreign-id',handle:'foreign',name:'Мимокрокодил',role:'Наблюдатель',color:'#0f766e',requested_model:'qwen',harness_instance_id:'local-hermes',harness_type:'hermes',model_id:'qwen',mode_id:null,group_id:null,archived_at:null},
];
const run:Run={id:'run',messageId:'message',agent:'foreign',harnessInstanceId:'local-hermes',harnessType:'hermes',modelId:'qwen',modeId:null,status:'completed',text:'',tools:[]};
