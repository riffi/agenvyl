import { isConnectorCatalog, isConnectorCommandResult, isConnectorConfigurationResult, isConnectorDiscovery, isConnectorExecutionEvent, isConnectorHealth, isConnectorInstanceList, isConnectorRequestCommandResult, isExecutionSnapshot, isTestConnectorInstanceResult, type ConfigureConnectorInstancesRequest, type ConnectorCatalog, type ConnectorConfigurationResult, type ConnectorDiscovery, type ConnectorExecutionEvent, type ConnectorHealth, type ConnectorInstanceList, type ConnectorRequestAnswer, type ConnectorRequestCommandResult, type ExecutionSnapshot, type StartExecutionRequest, type TestConnectorInstanceRequest, type TestConnectorInstanceResult } from '@agenvyl/connector-contract';
