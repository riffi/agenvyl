...
export class RunsService{
  constructor(private readonly dependencies:{runs:RunRepository;events:RoomEventService;activeRuns:ActiveRunRegistry;executor:RunExecutor;interventions:RunInterventionService}){}
