...
describe('setup API',()=>{
  ...
  it('bootstraps a fresh zero-harness installation atomically and idempotently',async()=>{
    ...
    const payload={locale:'ru',workspace_root:customWorkspaceRoot,profile:{display_name:'Владимир',handle:'vladimir'},route:null};
