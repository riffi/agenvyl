...
export class CodexAppServerClient implements CodexAppServerPort{
  ...
  private async open(){
    ...
    const initialized=await this.rawRequest('initialize',{clientInfo:{name:'agenvyl_connector',title:'Agenvyl Connector',version:'0.1.0'},capabilities:{experimentalApi:true,mcpServerOpenaiFormElicitation:true}});
