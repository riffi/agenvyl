...
export class ManagedHarnessServers{
  ...
  private async startOpenCode(instance:ConnectorInstanceConfig){
    ...
    const child=spawn(invocation.file,invocation.args,{env:this.env,stdio:'ignore',windowsHide:true,windowsVerbatimArguments:invocation.windowsVerbatimArguments});
